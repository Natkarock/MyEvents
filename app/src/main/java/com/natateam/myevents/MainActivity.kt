...
import com.natateam.myevents.extension.RC_SIGN_IN
...
class MainActivity : AppCompatActivity(),MainCotractor.AuthView {
    ...
    fun showEventActivityWithId(id: String?, type: String = Consts.TODO_TYPE) {
        val intent = Intent(this, EventActivity::class.java)
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == SELECT_PHONE_NUMBER && resultCode == RESULT_OK) {
            ...
            if (cursor != null && cursor.moveToFirst()) {
                ...
                val contactModel = ContactModel(null, gogle_id, email, name, group, number)
    ...
    override fun checkIsSignIn() {
        authPresenter.checkIsSign(this)
    }
